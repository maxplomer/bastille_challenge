  ...
  def get_node(url)
    ...
    root = Node.new('http://news.google.com')
      ...
      root.b = Node.new('http://www.cnn.com')
        root.b.b = Node.new('http://www.cnn.com')
          root.b.b.a = Node.new('http://www.cnn.com')
            root.b.b.a.a = Node.new('http://www.cnn.com')
          root.b.b.b = Node.new('http://www.cnn.com')
          root.b.b.c = Node.new('http://www.cnn.com')
            root.b.b.c.c = Node.new('http://www.cnn.com')
        root.b.c = Node.new('http://www.cnn.com')
          root.b.c.b = Node.new('http://www.cnn.com')
            root.b.c.b.b = Node.new('http://www.cnn.com')
